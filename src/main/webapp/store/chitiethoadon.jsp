...
<%--                <c:forEach items="${bill}" var="b">--%>
                <div class="align-items-center" style="margin-top: 30px">
                    <div style="height: 30px"><h5 style="float:left; margin-right: 10px">Mã hóa đơn: </h5><h4 style="float: right">${bill.id}</h4></div>
                    <div style="height: 30px;"><h5 style="float:left;">Tên khách hàng: </h5><h4 style="float: right; border-bottom: 10px">${bill.name}</h4></div>
                    <div style="height: 30px;"><h5 style="float: left">Ngày tạo: </h5><h4 style="float: right;">${bill.date}</h4></div>
                </div>
<%--                </c:forEach>--%>
            </div>
        </div>
