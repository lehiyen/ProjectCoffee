            ...
            <div class="navbar-header" data-logobg="skin5">
                ...
                <a class="navbar-brand" href="index.html">
                    ...
                    <b class="logo-icon p-l-10">
                        ...
                        <!-- Dark Logo icon -->
                        <img class="logo-admin" src="assets/images/logo-icon.jpg" alt="homepage" class="light-logo"/>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link has-arrow waves-effect waves-dark"
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="ThemTaiKhoan.html" class="sidebar-link"><span
                    ...
                    <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                href="quanlihoadon.html" aria-expanded="false"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><a href="chiTietHoaDon.html">11234H2</a></td>
                                        <td>Nhân Võ</td>
                                    ...
                                    <tr>
                                        <td><a href="chiTietHoaDon.html">11564H12</a></td>
                                        <td>Nhân Nguyễn</td>
                                    ...
                                    <tr>
                                        <td><a href="chiTietHoaDon.html">11234P2</a></td>
                                        <td>Nhân Tâm</td>
                                    ...
                                    <tr>
                                        <td><a href="chiTietHoaDon.html">11234FH2</a></td>
                                        <td>Nhân Từ</td>
